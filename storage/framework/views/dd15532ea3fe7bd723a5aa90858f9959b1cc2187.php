...
<h1 id="title">Welcome <?php echo e($guest->character); ?></h1>
    <div class="panel-body">

        <?php echo $__env->make('errors.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <form action="<?php echo e(url('/halloween/guest/' . $guest->character)); ?>" method="POST" class="form-horizontal">
            <?php echo e(csrf_field()); ?>

            <div class="form-groups">
                <div class="col-sm-6">
                    <input type="text" name="id" id="id" class="form-control hidden" value="<?php echo e($guest->id); ?>">
                </div>
                <div class="col-sm-6">
                <p>Your alter ego</p>
